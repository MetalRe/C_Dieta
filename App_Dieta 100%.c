...
int main(){
    ...
    Dados ali[14] = {
        ...
        {
            "Sódio", "mg",{0.82,0.57,0.61,0.61,0.14,65.70}
        },
        {
      ...
      int op;
          ...
          float man, woman, idade, carbo, p, lip, pd;
          /*for( int x = 0; x < 10; x++){
      ...
      do{
        ...
        printf("\n\t\t\t\t\t 2 - Informação Nutricional - Ovos e Leite: ");
        printf("\n\t\t\t\t     \t3 - Calcular Indice de Massa Corporal(IMC): ");
        printf("\n\t\t\t     \t 4- Calcular a quantidade de calorias baseado no seu peso: ");
        printf("\n\t\t\t   5 - Calcular a quantidade de Calorias para obter o Peso desejado: ");
        printf("\n\t\t\t     \t 6 - Calcular a quantidade de Calorias para perder Peso: ");
        printf("\n\t\t\t  7 - Calcular a qt de calorias necessárias por dia para manter o peso: ");
        ...
        /*3 Opção Dentro do MENU*/
            ...
            /*Lista das Somas de cada aminoácidos e protéinas*/
              ...
              //final do for
                ...
                break;
                case 2:
                    printf("\nOpção: 2 - Informação Nutricional : ");
                    int x = 0;
                do{
                    printf("\n\nPor favor informe o alimento que quer calcular: ");
                    printf("\nDigite:   \n( 1 ) Para Leite\n( 2 ) Para Ovos\n( 0 ) Para sair:\n");
                    ...
                    switch(escolha){
                    case 1 :
                       printf("\n=> Informação Nutricional - Proteína do Leite: ");
                       printf("\n# Digite quantos ml de Leite você Ingeriu hoje: ");
                       scanf("%f",&valor);
                        for(int x = 0; x < 14;x++){
                            printf("\n=> %s %.1f%s ", ali[x].nome, valor * ali[x].mult[3], ali[x].uni);
                        /*Lista das Somas de cada aminoácidos e protéinas*/
                            ValorNut[x] += valor * ali[x].mult[0];
                          }
                    break;
                    case 2:
                        system("cls");
                        printf("\n=> Informação Nutricional - Proteína do Ovo: ");
                        printf("\n# Digite quantos ovos cozido você comeu hoje: ");
                        scanf("%f",&valor);
                         for(int x = 0; x < 14;x++){
                            printf("\n=> %s %.1f%s ", ali[x].nome, valor * ali[x].mult[4], ali[x].uni);
                        /*Lista das Somas de cada aminoácidos e protéinas*/
                            ValorNut[x] += valor * ali[x].mult[0];
                          }
                     break;
                     ...
                     /*Resultado das somas*/
                        printf("\n\nLista de Aminoácidos e Vitaminas.\n=> Foi de aproxidamente %.1fg de Proteínas ",ValorNut[0]);
                        printf("\n=> Tem aproxidamente %.2fg de Gorduras \n=> Tem aproxidamente %.2fg Calorias: ",ValorNut[1],ValorNut[2]);
                        printf("\n=> Tem aproxidamente %.2fg de Sódio\n=> Tem aproxidamente %.2fg de Potássio: ",ValorNut[3],ValorNut[4]);
                        printf("\n=> Tem aproxidamente %.2fg de Vitamina C\n=> Tem aproxidamente %.2fg de Ferro: ",ValorNut[5],ValorNut[6]);
                        printf("\n=> Tem aproxidamente %.2fg de Vitamina B6\n=> Tem aproxidamente %.2fg de Magnésio: ",ValorNut[7],ValorNut[8]);
                        printf("\n=> Tem aproxidamente %.2fg de Cálcio \n=> Tem aproxidamente %.2f IU Vitamina D: ",ValorNut[9],ValorNut[10]);
                        printf("\n=> Tem aproxidamente %.2f IU Cobalamina: ",ValorNut[11]);
                        printf("\n=> Tem aproxidamente %.2fmg de Colesterol\n=> Tem aproxidamente %.2fg de Carboidratos: ",ValorNut[12],ValorNut[13]);
                ...
                for(int x = 0; x < 1; x++){
                 ...
                 break;
                  ...
                  case 4:
                  printf("\nOpção: 4 - Calcular a quantidade de calorias necessárias por dia: ");
                  for(int x = 0; x < 1; x++){
                        printf("\n\nPor favor Informe seu nome: ");
                        fflush(stdin);
                        gets(nome);
                ...
                /* } Fechando no lugar errado*/
                 ...
                 break;
                  case 5:
                  printf("\nOpção: 5 - Calcular a quantidade de Calorias para obter o Peso desejado: \n ");
                  for(int x = 0; x < 1; x++){
                 ...
                 break;
                 case 6:
                  printf("\nOpção: 6 - Calcular a quantidade de Calorias para perder Peso:\n ");
                  for(int x = 0; x < 1; x++){
                        printf("\n < Por Favor Informe sua a sua Idade > ");
                        fflush(stdin);
                        scanf("%f",&idade);
                        ...
                        scanf("%f",&alt);
                        printf("< Por Favor Informe seu peso para calcular quantas Kcal deve consumir por dia (kg) > ");
                        fflush(stdin);
                        scanf("%f",&peso);
                        fflush(stdin);
                        printf("\nPor Favor Informe se é Mulher ou Homem :\n<m> Para Mulher ou <h> Para Homem: ");
                 ...
                 /*Proteção contra Usuário indevidos/inconvenientes*/
                  ...
                  break;
                  case 7:
                  printf("\nOpção: 7 - Calcular a qt de calorias necessárias por dia para manter o peso: ");
                  for(int x = 0; x < 1; x++){
                        printf("\n< Por Favor Informe sua a sua Idade > ");
                        fflush(stdin);
                        scanf("%f",&idade);
